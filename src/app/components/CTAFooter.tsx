...
function Footer() {
  ...
  return (
    <footer
      ...
      className="px-6 lg:px-12 pt-16 pb-0"
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12">
            ...
            <div className="flex gap-4 mt-6">
              {[Linkedin, Instagram].map((Icon, i) => (
                <a
                  ...
                  onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "#EB0707"; }}
          ...
          {/* Col 2 – Services */}
          <div>
            <h4 style={{ fontWeight: 600, color: "#FFFFFF" }} className="text-sm mb-4 uppercase tracking-wider">
              {f.servicesHeading}
            </h4>
            <ul className="space-y-3">
              {f.services.map((item) => (
                <li key={item}><FooterLink label={item} /></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <span style={{ fontWeight: 400, color: "rgba(255,255,255,0.65)", fontSize: "14px" }}>
        ...
        {/* Divider */}
        <div style={{ height: "1px", backgroundColor: "#EB0707", opacity: 0.7 }} />

        {/* Bottom bar */}
        <div className="py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p style={{ fontWeight: 300, color: "rgba(255,255,255,0.50)", fontSize: "12px" }}>
            {f.copyright}
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <div>
                <p style={{ color: "#FFFFFF", fontWeight: 600, fontSize: "10px", lineHeight: 1.2, letterSpacing: "0.04em" }}>
                  LUOTETTAVA
                </p>
                <p style={{ color: "#FFFFFF", fontWeight: 600, fontSize: "10px", lineHeight: 1.2, letterSpacing: "0.04em" }}>
                  KUMPPANI
                </p>
                <p style={{ color: "rgba(255,255,255,0.45)", fontWeight: 300, fontSize: "8px", marginTop: "2px" }}>
                  tilaajavastuu.fi
                </p>
              </div>
            </div>
          ...
          <p style={{ fontWeight: 300, color: "rgba(255,255,255,0.35)", fontSize: "12px" }}>
            {f.legal}
          </p>
        </div>
      </div>
